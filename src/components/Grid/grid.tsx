            ...
            <div className="d-flex row">
              ...
              <div className="col-lg-9">
                ...
                <span className="grid__description text-black">
                  ...
                  Laboriosam laborum, temporibus molestias maiores harum ad hic
                  voluptatum magni cum, doloribus voluptates culpa sit dolore
                  corrupti numquam adipisci, dicta nam aliquam!
                </span>
              </div>
            </div>
          </div>
